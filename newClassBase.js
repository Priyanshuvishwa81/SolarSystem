...
let addColorSize = [
    { color: "white" },
    { color: "orange", size: 5, dis: 70 },
    { color: "pink", size: 7, dis: 150 },
    { color: "blue", size: 12, dis: 203 },
    { color: "red", size: 15, dis: 300 },
    { color: "wheat", size: 28, dis: 403 },
    { color: "gray", size: 22, dis: 520 },
    { color: "aqua", size: 21, dis: 620 },
    { color: "purple", size: 25, dis: 700 },
    { color: "green", size: 22, dis: 1100 },
...
function ShapeTheData() {
    ...
    for (let indx = 0; indx < MoonsData.length - 1; indx++) {
        ...
        let fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 20;

        for (let NoDataMoons = 0; NoDataMoons < PlanetsData[indx].Moons - MoonsData[indx].Moons.length; NoDataMoons++) {
            ...
            if (NoDataMoons < 20) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 8
            else if (NoDataMoons < 40) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 11;
            else if (NoDataMoons < 60) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 14
            else if (NoDataMoons < 80) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 16;
            else if (NoDataMoons < 100) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 18;
            else if (NoDataMoons < 120) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 11
            else if (NoDataMoons < 140) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 14;
            else if (NoDataMoons < 160) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 16;
            else if (NoDataMoons < 180) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 18;
            else if (NoDataMoons < 200) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 20;
            else if (NoDataMoons < 220) fiftAdd2 = MySubPlanet[indx].subPlanetRadius + 16;
        }
...
function UpdatePosXY(subPlanetPosXY, indx) {
    ...
    // console.table(MySubPlanet[MySubPlanet.length-1]);
    // console.log( MySubPlanet[MySubPlanet[indx].mybasePlanetID]);
}
